...
export const routeRegistry: RouteMetadata[] = [
  ...
  { id: 'billing.plans', matcher: '/billing/plans', permission: 'billing.plans.read', featureFlag: 'billing', tenantRequired: true, nav: { href: '/billing/plans', label: 'Subscription', icon: 'billing', group: 'Billing' } },
