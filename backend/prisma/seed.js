...
const permissions = [
  ...
  { code: 'platform.organizations.delete', module: 'platform', description: 'Soft-delete organizations' },
  { code: 'platform.impersonate', module: 'platform', description: 'Impersonate tenant workspace (support)' },
  { code: 'platform.plans.read', module: 'platform', description: 'Read subscription plans (catalog)' },
  { code: 'platform.plans.create', module: 'platform', description: 'Create subscription plans' },
  { code: 'platform.plans.update', module: 'platform', description: 'Update subscription plans' },
